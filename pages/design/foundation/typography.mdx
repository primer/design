...
Inter UI and SF Mono are not system-fonts, rather they are used in specialized use cases to diffierentiate information and establish hierarchy.
...
**Display Face**—font-stack used for displaying Inter UI
