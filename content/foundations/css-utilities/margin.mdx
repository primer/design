...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--uniform)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--directional)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--directional-extended)

## Center elements

Use `mx-auto`to center block elements with a set width.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--auto)

We also provide directional margin auto. `mt-auto, mr-auto, mb-auto, ml-auto`

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--auto-directional)

## Reset margins
Reset margins built into typography elements or other components with `m-0`, `mt-0`, `mr-0`, `mb-0`, `ml-0`, `mx-0`, and `my-0`.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--reset)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--responsive)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--negative)

## Extended negative margins

You can use the extended spacing scale for `top` and `bottom` margins, ranging from `1` to `12`.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-margin--negative-extended)
