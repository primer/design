...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--display)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--table)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--responsive)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--responsive-hide)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--floats)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--floats-responsive)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--align)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--align-text)

## Width and height

Use `.width-fit` to set max-width 100%.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--width-fit)

Use `.width-full` to set width to 100%.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--width-full)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--width-auto)

Use `.height-fit` to set max-height 100%.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--height-fit)

Use `.height-full` to set height to 100%.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--height-full)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-relative)

### Absolute

Use `.position-absolute` to take elements out of the normal document flow.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-absolute)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-fixed)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-fixed-filled)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-sticky-top)

#### Bottom

Combine `.position-sticky` with `.bottom-0` to keep an element stuck to the bottom. Can be used as a footer or toolbar.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-sticky-bottom)

#### Left and right

Combine `.position-sticky` with `.left-0` or `.right-0` to keep elements stuck to the left or right when scrolling horizontally.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-sticky-left-right)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--position-responsive)
...
[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--screen-reader-only)

## The media object

Create a media object with utilities.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--media-object)

Create a double-sided media object for a container with a flexible center.

[Storybook](https://primer.style/css/storybook/?path=/story/utilities-layout--media-object-double)
