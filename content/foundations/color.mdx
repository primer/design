...
When you combine colors like foreground and background, they must fulfil the [required wcag contrast](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum.html). 
...
Use an [online contrast checker](https://webaim.org/resources/contrastchecker/) or a [figma plugin](https://primer.style/design/accessibility/tools#contrast-plugin) to test your contrast. If you work with the primer primitives, this work has already been done for you. We checked all recommended combinations, so you are all set.
