...
| ![](https://swatch-sid.vercel.app?mode=light&token=neutral.emphasisPlus) `bg.onEmphasis` | Provides the highest contrast against the default background, such as in tooltips.                                 |
