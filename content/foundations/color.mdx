...
<DoDontContainer>
  <Do>
    <img src="https://user-images.githubusercontent.com/6951037/145223860-4db73d78-8791-44db-b94d-c7966ce13fab.png" />
    <Caption>Example of pairing foundation variables: ```bg.subtle``` with ```border.muted```"</Caption>
  </Do>
  <Dont>
    <img src="https://user-images.githubusercontent.com/6951037/145223862-2ea9027c-1474-47d0-8caf-8ab8d93a841b.png" />
    <Caption>Tihinking about elevation ```bg.inset``` would be the underground. It's meant to create a feeling of focus or depth</Caption>
  </Dont>
</DoDontContainer>

<DoDontContainer>
  <Do>
    <img src="https://user-images.githubusercontent.com/6951037/141304060-1e3d5285-f80f-4363-8c07-e5865c6fe073.png" />
  ...
  <Dont>
    <img src="https://user-images.githubusercontent.com/6951037/141304173-5f919074-b5ae-4c0b-b5d2-8a2cd6ea2d03.png" />
...
<DoDontContainer>
  <Do>
    ...
    <Caption>nly use fg.muted on default, subtle, inset.</Caption>
  </Do>
  <Dont>
