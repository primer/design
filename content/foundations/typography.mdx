...
import segoeImage from '../../src/images/svg/segoe.svg'
import sfImage from '../../src/images/svg/sf.svg'
import sfMonoImage from '../../src/images/svg/sfMono.svg'
import interImage from '../../src/images/svg/interUI.svg'
import ubuntuImage from '../../src/images/svg/ubuntu.svg'
...
```css
font-family: InterUI, -apple-system, BlinkMacSystemFont, 'Helvetica Neue', 'Segoe UI', Oxygen, Ubuntu, Cantarell, 'Open Sans',
  sans-serif;
```
