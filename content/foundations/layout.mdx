...
<p><img src="https://user-images.githubusercontent.com/293280/193166608-82aa77e2-4369-4c27-a504-f2d3bbe0d7a3.png" alt="" width="960" /></p>
...
Narrow viewport options
- Stack vertically
- Split into different pages
- Show pane as bottom sheet
...
<Box display="grid" gridTemplateColumns={['1fr', null, null, null, '1fr 1fr']} gridGap={5}>
  <Box justifyContent="center">
      <img
        width="464"
        alt=""
        src="https://user-images.githubusercontent.com/293280/193164769-c5d1a0c3-9219-4068-ab7c-e7581b0faf7c.png"
      />
  </Box>
  <Box>
  ...
  <Box justifyContent="center">
      <img
        width="464"
        alt=""
        src="https://user-images.githubusercontent.com/293280/193164767-3818b146-b035-4085-91fa-4a6482b5735b.png"
      />
  </Box>
  <Box>
...
List-detail patterns, such as settings pages, can be split into different pages when the viewport is narrow.
  ...
  <Box justifyContent="center">
      <img
        width="464"
        alt=""
        src="https://user-images.githubusercontent.com/293280/193164765-d3d0e01f-5250-4d06-9570-d33b5229d6ce.png"
      />
  </Box>
  <Box>
      <Heading as="h3" sx={{fontSize: 3, mb: 2}}>Show pane as bottom sheet</Heading>

Auxiliary panes can be displayed as bottom sheets.
