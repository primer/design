...
For example when setting the content area to `xlarge`, the width of the content area will have a max-width of 1280px. The 1280px includes the padding, which means that visually, the width of the content area on an `xlarge` breakpoint will only be 1232px.
...
![](https://github.com/user-attachments/assets/4e47b827-3263-4b4b-a59a-d71d3df1fcd4)
