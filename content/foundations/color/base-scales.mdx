...
Contrast levels can be adjusted by moving up or down the scale. For example, the light high contrast theme utilizes steps one through 6 for backgrounds, 9 for borders, and 10 to black for text.
