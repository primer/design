...
>
  <Box as="p" mt="0">
    ...
    show state with more than a change in color. 
    
    Unless color is only used as a visual "flourish", the information that the color conveys must be present either in the text (e.g. in the case of buttons, the actual wording of the button label), or through some additional visual cue (such as an icon).
  </Box>
  <img
    width="456"
