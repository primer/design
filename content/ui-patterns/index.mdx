...
#### [Overlays](/ui-patterns/overlays)

An overlay is a flexible floating surface, used to display transient content such as menus, selection options, dialogs, and more. This guideline covers usage, anatomy, placement and responsive variants.
