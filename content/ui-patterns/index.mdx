...
<Grid gridGap={4}>
    ...
    {/* <div>
        <Link href="/design/ui-patterns/forms">
            <img role="presentation" src="" />
        </Link>
    </div> */}
    <div>
        <Link href="/design/ui-patterns/forms" fontWeight="bold">Forms</Link>
        <Box as="p">Forms are used to complete tasks that require data input from the user. These guidelines aim to minimize the effort and cognitive load required to complete a task that involves a form.</Box>
    </div>
    {/* <div>
