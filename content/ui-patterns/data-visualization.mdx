...
| Primary chart marks \| 1 - 7 datasets                                                 | 
| :------------------------------------------------------------------------------------ |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.blue.5) `--data-blue-color`     |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.green.4) `--data-green-color`   |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.orange.4) `--data-orange-color` |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.pink.5) `--data-pink-color`     |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.yellow.4) `--data-yellow-color` |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.red.5) `--data-red-color`       |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.purple.5) `--data-purple-color` |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.auburn.5) `--data-auburn-color` |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.teal.5) `--data-teal-color`     |
| ![""](https://swatch-sid.vercel.app?mode=light&token=scale.gray.6) `--data-gray-color`     |
