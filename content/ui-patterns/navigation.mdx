...
{/* TODO: update the layouts for narrow viewports so the images go below their headings */}
...
Be mindful of data loss when a user is navigating away from a page where they have unsaved changes. See the [saving](/ui-patterns/saving) guidelines for more info.
...
Navigation within the same page, but to a different state. Strive to avoid full page reloads when feasible to maintain a fast and smooth user experience.
