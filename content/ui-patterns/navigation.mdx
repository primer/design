...
In Primer, navigation encompasses various components and patterns to enhance user experience by streamlining task completion.
...
When users activate a different state of their current page. When using this kind of navigation, strive to avoid full page reloads when feasible. This could help maintain a fast and smooth user experience.
...
When users navigate to a different section or move focus to a specific element within the same page. The page content is not changed. This behavior is commonly used for scrolling to new sections or focusing on input fields.
...
A global navigation can include direct links and dropdown buttons that reveal menus with more links.

There is no Primer component for global navigation. Use the other Primer components to build a global navigation that suits your needs.
...
<img
    ...
    src="https://github.com/primer/design/assets/2313998/75c0f52b-5b1e-4aab-bc26-af697c4fe3ec"
/>
...
When being used as navigation, activating a segmented control option may or may not change the URL.
