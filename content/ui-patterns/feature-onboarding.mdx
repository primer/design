...
<Flex my={3}>
  <Box width="100%" mr="2">
    <BorderBox border="1px solid" borderColor="red.5" mb="2" overflow="hidden">
...
<Flex my={3}>
  <Box width="100%" mr="2">
    <BorderBox border="1px solid" borderColor="green.5" mb="2" overflow="hidden">
      <img src="https://user-images.githubusercontent.com/6744014/89225349-eb6bbc00-d58e-11ea-82b1-b84e8d35b1df.png" alt="Example of the Blank Slate component in the Wiki tab of a repository." />
    </BorderBox>
  ...
  <Box width="100%">
    <BorderBox border="1px solid" borderColor="green.5" mb="2" overflow="hidden">
      <img src="https://user-images.githubusercontent.com/6744014/89225996-0c80dc80-d590-11ea-9e08-b86b2022b7eb.png" alt="Example of a teaching bubble pointing out a new collaboration tool on GitHub" />
    </BorderBox>
    <Text fontWeight="bold" color="green.5">
      Do:
...
<Flex alignItems="center" flexDirection="column" my={3}>
  <BorderBox width={9 / 12} mb="2" overflow="hidden">
    <img src="https://user-images.githubusercontent.com/6744014/89254175-62c33f00-d5d3-11ea-8b95-7faaea7ae71b.png" alt="Example of the success state toast component " />
  </BorderBox>
...
<Flex alignItems="center" flexDirection="column" my={3}>
  <BorderBox width={12 / 12} border="1px solid" borderColor="green.5" mb="2" overflow="hidden">
    <img src="https://user-images.githubusercontent.com/6744014/88745191-40768080-d0fe-11ea-97ae-6d9139027646.png" alt="Example of a page banner on the code tab of a repository" />
  </BorderBox>
...
<Flex alignItems="center" flexDirection="column" my={3}>
  <BorderBox width={12 / 12} border="1px solid" borderColor="red.5" mb="2" overflow="hidden">
    <img src="https://user-images.githubusercontent.com/6744014/88744095-3acb6b80-d0fb-11ea-876e-c461ee96de7c.png" alt="Example of a page banner pointing out a small feature change" />
  </BorderBox>
