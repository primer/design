...
<Flex alignItems="center" flexDirection="column" my={3}>
  ...
  <p><Text fontWeight="bold" color="red.5">Don't:</Text> Don't forget to check coinciding feature releases on the same page.</p>
</Flex>
...
Use page banners for annoucements that are relevant to the core task on the current page. Remember to consider using other feature announcement patterns or marketing strategies instead of disturbing the user with multiple announcements.
...
<Flex alignItems="center" flexDirection="column" my={3}>
  ...
  <p><Text fontWeight="bold" color="red.5">Don't:</Text> Don't use a page banner to disproportionately highlight a small feature.</p>
</Flex>
