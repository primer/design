...
The Primer forms framework is designed to be accessible by default, integrate deeply with Rails, follow web standards, and adhere to Primer's <Link href="/design/ui-patterns/forms/overview">form interface guidelines</Link>.
