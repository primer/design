...
- If the change occurred without a redirect or page refresh, you can use the [inline message component](/components/inline-message).
- If the change occurred and the page refreshes or redirects, you can use a [banner component](/components/banner).
