...
<!--
TODO: Update this screenshot to be a DO/DON'T
- DO: Show one save button on the page
- DON'T: Show a save button for each section of the page
-->
...
<!--
TODO: Update these screenshots to not show the toggle switch
-->
<DoDontContainer>
  <Do>
...
<!-- TODO: Update the image in this example -->
<Box mb={3} display="flex" alignItems="flex-start" flexDirection={["column", "column", "column", "column", "row"]} sx={{gap: 4}}>
    <img
        width="456"
