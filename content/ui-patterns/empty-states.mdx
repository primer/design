...
For new user experiences, we suggest using illustrations for the graphic element of these blankslates to differentiate from the more common default blankslate.

Primary text should welcome the user to the platform and feature. Secondary text should seek to educate the user, but at a simpler, less-technical level.
