...
It is ok to show sequential navigation items in a loading state to avoid a layout shift. However, sequential _groups_ of navigation items should be replaced with a single loading indicator as mentioned in the [previous section](#sequential-and-related-groups-of-navigation-items).
