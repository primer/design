...
To ensure that assistive technology is informed about the filter update, put the message in an element with the following attributes: `aria-live="polite"` and `aria-atomic="true"`.
...
<img width="456" role="presentation" src="https://github.com/primer/design/assets/2313998/4048c1b7-6f39-4dea-9b51-9de466f3e033" />
</Box>
