...
<img
  ...
  src="https://github.com/primer/design/assets/2313998/c39c86c9-a4ad-4516-9057-40812922c2a6"
/>

If some links in the right side sheet cannot be loaded, shoe each [nav list](components/nav-list) item in an inert state. The users should still be able to hover, click, and focus inert items, but they don't link to anywhere. Optionally, a tooltip may be displayed explaining that the navigation item is unavailable.

<img
  width="960"
  alt="5 images. 1. Nav items loading - grouped items replaced with single loading state; 2: All items in group loaded; 3. Nav items loading - sequential ungrouped items where each is replaced with a loading state. Their labels are replaced with text that says 'Loading...'; 4: Nav items loading - sequential ungrouped items where each is replaced with a loading state; 5: All items in the group are loaded."
  src="https://github.com/primer/design/assets/2313998/315f1028-2409-46bb-87fe-5541527344cb"
/>
