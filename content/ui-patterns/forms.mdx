...
Inline validation provides immediate feedback while the user is entering data. For example: when setting a username, you could show a success message if the name is available or an error message if it’s taken.
