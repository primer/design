...
![Action menu, autocomplete input with limited options, checkbox group, radio group, select](https://user-images.githubusercontent.com/2313998/166832271-1b7b6e56-9716-4edc-8a11-9cf5ff9d9311.png)
...
<Box mb={4} display="flex" alignItems="flex-start" flexDirection={["column", "column", "column", "column", "row"]} sx={{gap: 3}}>
  <img
    width="456"
    role="presentation"
    src="https://user-images.githubusercontent.com/293280/123880964-95b3a700-d8f8-11eb-9775-cbaf165207ed.png"
  />
  <div>
...
<Box mb={4} display="flex" alignItems="flex-start" flexDirection={["column", "column", "column", "column", "row"]} sx={{gap: 3}}>
  <img
    role="presentation"
    width="456"
    src="https://user-images.githubusercontent.com/2313998/166846797-3200ea71-698b-470b-a992-513a6df2b7b5.png"
  />
  <div>
...
<Box mb={4} display="flex" alignItems="flex-start" flexDirection={["column", "column", "column", "column", "row"]} sx={{gap: 3}}>
  <img
    role="presentation"
    width="456"
    src="https://user-images.githubusercontent.com/2313998/166846806-613c00c4-950e-47b4-bf2d-262af9bcb8d0.png"
  />
  <div>
