...
- Copy button, the copy to clipboard action was successful.
  ![After clicking the copy icon button, a green checkmark appears to the right of the icon button.](https://github.com/user-attachments/assets/dce45835-2aac-4a5b-8229-e815a324521a)
- Creating multiple new issues.
  ![After clicking the Create button, an inline message appears below the Create button that says, Issue #21 created, with Issue #21 being a link.](https://github.com/user-attachments/assets/79770182-b1b2-44c5-a587-88f7ae821b1a)
