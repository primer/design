...
| Primary   | ![btn-primary](https://user-images.githubusercontent.com/24916540/52498773-86e4c200-2b8e-11e9-804f-146d721d5191.png)   | To emphasize the highest priority action on a view                                      |
...
Buttons that only use an icon should still have a label to make them accesssible to assistive technology (for example: read aloud by a screenreader)
...
Counts can be added as numerical aid in appropriate scenarios by providing valuable context. For example, showing social proof by displaying the number of people watching a repo.
