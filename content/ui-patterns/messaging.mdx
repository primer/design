...
Messaging components combine state with message type to provide the appropriate level of prominence. To determine which component to use for your message, start by identifying the message state. From there, follow the decision tree to pick a component best suited for your use case.
...
- a degraded experience(link) due to connectivity or GitHub availability
- a non-destructive action with side-effects like costs or access changes is about to take place

<img
  width="960"
  alt="draft wip"
  src="https://github.com/primer/css/assets/18661030/ae82693a-e18c-425f-9f63-e2077012e76b"
/>
...
- an issue has been transferred successfully

<img
  width="960"
  alt="draft wip"
  src="https://github.com/primer/css/assets/18661030/a3612e09-97b2-4ff5-903a-e85d1587ce50"
/>
...
Reserve the `unavailable` state for **inline** system related degraded experiences.
...
<img
  width="960"
  alt="draft wip"
  src="https://github.com/primer/css/assets/18661030/91cb6c58-40f4-41cd-b406-b5ed7560c9ea"
/>
