...
- _Toasts or banners are best suited for this type of messaging._

**Highlights**: bring attention to how and why to engage with a feature

- _Popovers are best suited for new features, callouts are the right choice when highlighting information about a feature or form._

**Updates**: inform the user of errors or necessary updates or changes to the product as it relates to them.

- _System alerts are best suited for this type of messaging._
