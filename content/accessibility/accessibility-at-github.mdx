...
<Note>When reading through accessibility information, you might find the common abbreviation: "a11y". A11y is a shortening of the word "accessibility". It starts with the first letter, "a", uses the number 11 for the eleven characters inbetween the first and last letter, and ends with the last letter, "y".</Note>
...
- Check the [github/accessibility](https://github.com/accessibility) repository (accessible to GitHub staff only) for information on events or learning resources 
