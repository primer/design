...
In many cases, devices that have been designed with accessibility in mind for a portion of the population ends up benefiting everyone. Take the OXO brand's Good Grips line of products. They were developed for people who have arthritis, but they ended up being easier to use for everyone.
...
Currently, [Section 508](https://www.access-board.gov/guidelines-and-standards/communications-and-it/about-the-ict-refresh/overview-of-the-final-rule) required by law follows WCAG 2.0 AA guidelines for compliance. 

## Who should we consider when designing? 
There are a whole host of situations to think about, though the majority will fall into one of these categories: 
