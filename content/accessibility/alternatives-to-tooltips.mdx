...
Often, tooltips duplicate content that is already available on the page making the tooltip redundant. Remove the tooltip if it's unnecessary.
...
<DoDontContainer stacked>
    ...
    <Dont>
       <Caption>Don't set tooltips on static elements nor set long content inside a tooltip</Caption>
       <img width="800" alt="Screenshot of GitHub pricing page that initially used a tooltip to hdie and show long descriptions for each point made" src="https://user-images.githubusercontent.com/16447748/159561347-1c2c9d38-7082-44f7-b9d8-642c8cca8085.png" />
    </Dont>
</DoDontContainer>

### Other

Consult a designer or your accessibility team for advice on alternatives to tooltip.
