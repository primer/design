...
If you're designing a new component or control for GitHub that will not be made up of one single [standard semantic markup](https://www.w3schools.com/html/html5_semantic_elements.asp), then check out a11yportal's [custom component creation checklist for user experience designers](https://www.a11yportal.com/guidelines/fundamentals/checklists.html#custom-control-checklist-ux).
...
This [Figma file](https://www.figma.com/file/o3Vhxw4SmBsUjeaVq3nF4y/Accessibility-Notation?node-id=0%3A1) includes annotations to use on your designs prior to developer-hand off. These annotations let you note accessibility information like desired tab order, screen reader labels, headings, and landmarks.
