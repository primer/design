...
This [Figma file](https://www.figma.com/file/o3Vhxw4SmBsUjeaVq3nF4y/Accessibility-Notation?node-id=0%3A1) includes annotations to use on your designs prior to developer-hand off. These annotations will allow you note accessibility information like desired tab order, screen reader labels, headings, and landmarks.
