...
When sites are built without adequate responsivity considerations (for example: setting fixed width and height, using non-relative font sizing), sites may become completely unreadable 
