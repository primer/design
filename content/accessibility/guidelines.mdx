...
#### Alt-text
Use the HTML `alt` attribute when labeling an image. If the image has a descriptive caption already, you should give the image an attribute of `alt=""`. This will prevent the screenreader from telling the user about the image multiple times.
