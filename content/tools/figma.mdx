...
GitHub's Figma organization is currently maintained by our design systems team. For any questions or comments please reach out to us either in our Slack [#design-systems](slack://channel?id={C0ZCGGGJ2}) channel or by leaving an issue in the [github/design-systems repo](https://github.com/github/design-systems/issues/new/choose). The design systems team also offers weekly Figma office hours on Tuesday's which are hosted by [@ashygee](https://github.com/ashygee). Please reach out to them for the calendar invite.
