---
title: Breadcrumbs
description: The breadcrumbs component displays the current page or context within the site, allowing them to navigate different levels of the hierarchy.
reactId: breadcrumbs
