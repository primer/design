...
<Note variant="danger">
  ...
  <Text>
    ...
    with zero or little visual indicator of its existence. See tooltip alternaitves below before using this component.
  </Text>
</Note>
...
<DoDontContainer>
  <Do>
    <img
      width="800"
      alt=""
      src="https://github.com/primer/primitives/assets/18661030/d5528bb1-cf2e-41f6-b029-d861fb28375b"
    />
    <Caption>Do use tooltips for icon buttons that serve unique purposes</Caption>
  </Do>
  <Dont>
    <img
      width="800"
      alt=""
      src="https://github.com/primer/primitives/assets/18661030/9713ad8b-9f52-44fd-8b46-06d5151b813f"
    />
    <Caption>
      Don’t use tooltips for icon buttons that appear in a group of other controls which share the same functionality,
      such as opening a context menu.
    </Caption>
  </Dont>
</DoDontContainer>
...
>
  <img
    ...
    src="https://github.com/github/primer/assets/18661030/558ef7a5-3757-407a-a7fa-5f32e799d8b1"
  />
  <Box as="p" mt="0">
    For interactive controls with no visible text label, a tooltip can be used to provide one. This label should be
    short and descriptive just as you would for a button with visible text.
  </Box>
</Box>
...
>
  <img
    ...
    src="https://github.com/github/primer/assets/18661030/e6e6a3df-0e02-4c44-9b4d-f2e44c83dc9e"
  />
  <Box as="p" mt="0">
...
<img
  width="960"
  role="presentation"
  src="https://github.com/github/primer/assets/18661030/ff78c4d2-721d-45b7-a357-f6d1e9a7cba8"
