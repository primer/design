...
- View all [open accessibility issues related to this component](https://github.com/github/primer/issues?q=is%3Aopen+is%3Aissue+label%3A%22component%3A+tooltip%22+label%3Aaccessibility) (only available to GitHub staff).
