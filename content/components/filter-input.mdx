...
It's important to stick to an icon for clearing the input to avoid any confusion with the value of the input. Especially when the input has a value that is long and gets close to the clear button this could be an problem if it was a link.
