...
<Note>
  This component is currently unavailable for development and we are seeking <a href="/guides/contribute/how-to-contribute#design-or-build-new-patterns">contributors</a> to build it.
</Note>
...
### Known accessibility issues (GitHub staff only)
 ...
 <AccessibilityLink label="FilterInput"/>