...
<DoDontContainer>
  <Do>
    <img
      ...
      role="presentation"
      width="456"
      alt="A input that has a magnifying glass icon on the left side."
    />
  ...
  <Dont>
    <img
      ...
      role="presentation"
      width="456"
      alt="A input that has a filter icon on the left side which consists out of 3 lines getting incrementally smaller."
    />
...
<DoDontContainer>
  ...
  <Dont>
    <img
      ...
      role="presentation"
      width="456"
      alt="A input without a value showing a clear button in it on the right."
    />
...
While this applies to all qualifiers we do understand that for the ones that depend on our api endpoints (`users`, `repositories`, `organisations`...) we can't always accurately match every result and therefore while not ideal we can always highlight those. For example when not single signed-on to a organisation some repositories might not be returned.
...
Some qualifiers like `location:` might have values which contain spaces. eg: `Amsterdam, Netherlands`. In this we encapsulate the value between straight quotes (not smart quotes).
...
<DoDontContainer>
  ...
  <Dont>
    <img
      ...
      width="456"
    />
    <Caption>Don't use quotes around values with spaces.</Caption>
  </Dont>
</DoDontContainer>
...
<DoDontContainer>
  <Do>
    <img
      ...
      role="presentation"
      width="456"
      alt="A empty filter input showing initial suggestions: `Assignee`, `Is`, `Repository`, `State` and `Total comments`"
    />
  ...
  <Dont>
    <img
      ...
      role="presentation"
      width="456"
      alt="A empty filter input showing initial suggestions with all the possible combinations: `assignee: username, username`, `is: pr, issue, project`, `repo: github/github, github/primer`, `state: open, closed, draft`, `comments: >400, 100...200`"
    />
