...
<DoDontContainer>
  <Do>
    ...
    />
    <Caption>Auto update results based when the input value changes.</Caption>
  </Do>
  <Dont>
    <img
    ...
    />
    <Caption>Don't add a item to submit the current value.</Caption>
  </Dont>
</DoDontContainer>
...
When suggesting content avoid repetitive icons or descriptions to increase readability and reduce noise for screen readers.
...
<DoDontContainer>
  <Do>
    <img
      ...
      role="presentation"
      width="456"
      alt="An input with a value 'pinned:' suggesting 'Application', 'Form submissions', 'Performance', 'Feature requests', 'Large data sets' and 'Issues'. None of the items has a icon or additional descriptions."
    />
    <Caption>
