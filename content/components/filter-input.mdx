...
The filter input comes with a list of predefined qualifiers to ensure different products align on the same terminology as well as the design of suggestions.
