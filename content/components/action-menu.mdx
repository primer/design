...
>
  <img
    width="456"
    alt=""
    src="https://user-images.githubusercontent.com/18661030/226486484-ebf7b721-a98b-4ffd-abae-97bdf4493c2c.png"
  />
  <Box as="p" mt="0">
...
<DoDontContainer>
  ...
  <Dont>
    ...
    />
    <Caption>For complex interactions, use SelectPanel.</Caption>
  </Dont>
</DoDontContainer>
...
| <Box as="kbd" backgroundColor="canvas.subtle" borderRadius={1} borderColor="border.default" borderWidth={1} borderStyle="solid" py={1} px={2}>Home</Box>       | Move focus to firt item                                         |
| <Box as="kbd" backgroundColor="canvas.subtle" borderRadius={1} borderColor="border.default" borderWidth={1} borderStyle="solid" py={1} px={2}>PageUp</Box>     | Move focus to firt item                                         |
