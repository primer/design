...
<Note>Multi level is not available yet in the React or Rails implementation.</Note>
...
Don't use trailing visuals to add additional interactions instead keep them reserved for submenu indicators or keyboard shortcuts.
