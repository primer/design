...
When using a button the menu can be opened by tapping it or through left clicking it with a mouse. When the focused it can also be opened by hitting `return`, `space` or any `arrow` key.
...
Menus close in multiple scenarios:

- Clicking on a menu item
- Clicking outside the menu
- Pressing `Enter` on a menu item
- Pressing `Esc`
- Pressing `Tab`
