...
<img
  ...
  role="presentation"
/>
<Caption>A list of items using the past relative outputs.</Caption>

### Future

As well as the past dates, future dates outputs different formats depending on the time difference.
...
A relative time is used as plain text in most of the cases. However, it can be used as an anchor link to point to an element within a view that contains relevant or nested information.
