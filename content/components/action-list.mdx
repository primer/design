...
<Grid gridTemplateColumns={['1fr', null, null, null, '1fr 1fr']} gridGap={5}>
    ...
    <div>
        ...
        <Flex as="p">When listing system sections, features, or options, use leading visuals to improve the items' scannability. In user-generated objects, they can help to indicate the item's content type and status.</Flex>
