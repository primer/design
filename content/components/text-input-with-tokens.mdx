...
description: A text input with tokens is an input for a value that is a list.
...
<Box display="flex" flexDirection={['column', 'column', 'column', 'column', 'row']} sx={{gap: 3}}>
  ...
  <CustomVideoPlayer
    width="456"
    loop
    src="https://user-images.githubusercontent.com/2313998/224811745-416efef7-4580-474d-b8f2-5760a9559018.mp4"
  />
</Box>
...
<Box display="flex" flexDirection={['column', 'column', 'column', 'column', 'row']} sx={{gap: 3}}>
  ...
  <CustomVideoPlayer
    width="456"
    loop
    src="https://user-images.githubusercontent.com/2313998/224812132-76583b8f-03f7-4428-a1ff-686e0e2b36f5.mp4"
  />
</Box>
