...
<img
  ...
  src="https://user-images.githubusercontent.com/980622/209174321-98aed0f4-d39f-45ea-9828-212c51b6003f.png"
/>
...
The state of an action can be displayed by using a stroke and fill icon combination or by using the opposite version of the icon if available
...
<Do>
  <img
    width="456"
    alt="The save and subscribe action buttons in notifications are special cases where a slash version of the icon is used for the 'off'/'empty' state."
    src="https://user-images.githubusercontent.com/10384315/103726215-3b5f0c80-4f8d-11eb-974a-8efc2a8643a6.png"
  />
  <Caption>
    The save and subscribe action buttons in notifications are special cases where a slash version of the icon is used
    for the "off"/"empty" state.
  </Caption>
</Do>
