...
description: Our icons are located in a separate library called Octicons, which is available in various implementations including React, Figma, Rails, and Styled System.
---
...
At Primer, we utilize the [Octicons](/octicons/) icon library. This package is available in [Ruby](/octicons/packages/ruby), [Jekyll](/octicons/packages/jekyll), [JavaScript](/octicons/packages/javascript), [React](/octicons/packages/react) and [Styled System](/octicons/packages/styled-system).
