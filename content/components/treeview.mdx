...
Either all nodes have leading visuals, or no nodes have leading visuals.
...
<DoDontContainer>
  <Do>
    ...
    />
    <Caption role="presentation" color="fg.subtle">
      Render all nodes with leading visuals or as text-only
    </Caption>
  </Do>
  <Dont>
    <img
...
In devices with `:hover` support, the nesting indicator lines fade in when the user mouses over the entire component, or when there's focus inside the component.
...
<Box as="figure" role="presentation" m={0}>
  <img
    ...
    src="https://user-images.githubusercontent.com/2313998/187768691-94e40dad-eac6-48a7-bf1e-b9b02e927977.png"
  />
  <Caption color="fg.subtle">A tree view being rendered in a split page layout.</Caption>
</Box>
...
<Box as="figure" role="presentation" m={0}>
  <img
    ...
    src="https://user-images.githubusercontent.com/2313998/187768696-a7f87aa4-a9a3-44f0-a0b5-9d04820a684e.png"
  />
  <Caption color="fg.subtle">A tree view that replaces itself with the content of the activated node.</Caption>
</Box>
