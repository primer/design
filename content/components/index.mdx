...
<Grid gridTemplateColumns={['1fr', null, null, null, '1fr 2fr']} gridGap={4}>
    ...
    <div>
        <Link href="/design/components/button">
    ...
    <div>
        <Link href="/design/components/button" fontWeight="bold">Button</Link>
        <Box as="p">A button is the basic user action component</Box>
    </div>
    <div>
