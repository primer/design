...
To learn more about anatomy, input methods, forms structure, validation, and more, please refer to our [Forms guidance](../ui-patterns/forms.mdx).

## Related links

- [Forms](../ui-patterns/forms.mdx)
- [Checkbox]()
- [Checkbox group]()
- [Radio]()
- [Radio group]()
