...
When Narrow, all title variants appear as medium.
...
When Narrow, all visual regions remain visible by default.
...
When Narrow, all action regions are hidden by default. A back button should appear as a Parent link. Any trailing action should be hidden in an overflow button on the side.
