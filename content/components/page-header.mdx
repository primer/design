...
1. PageHeader.TitleArea
  1. PageHeader.LeadingVisual
  2. PageHeader.Title
  3. PageHeader.TrailingVisual
2. ContextArea
  1. ContextArea.ParentLink
  2. ContextArea.ContextBar
  3. ContextArea.ContextAreaActions
3. PageHeader.LeadingAction
4. PageHeader.TrailingAction
5. PageHeader.Actions

The main motivation behind this ordering is to make sure all interactive content in the page header comes after the main heading of the page (PageHeader.Title). With this approach, we can ensure that the screen reader users who are navigating through heading menu don't miss any of those interactive content. 
