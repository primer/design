...
figma: https://www.figma.com/file/8H2GJvKbSpPD0gQiz33OCQ/PageHeader-(FY23-Q1)-(Copy)?node-id=2%3A2259&t=8op3qWsrQ1Fai7vS-1
---
...
### Context bar responsive strategy

On narrow viewports, the Parent link touch target expands beyond its element boundaries, to match with the minTouchTarget design token.

<img 
    src="https://user-images.githubusercontent.com/586552/222216317-c8478ab0-6541-49c6-9140-bc884e9a8cd4.png"
    role="presentation"
    width="877"
    alt="Page header context bar in a narrow viewport"
/>
...
### Title bar responsive strategy

In narrow viewports, all title variants appear as medium.
...
### Title bar visual regions responsive strategy

In narrow viewports, all visual regions remain visible by default.
...
### Title bar action regions responsive strategy

In narrow viewports, all action regions are hidden by default. A back button should appear as a Parent link. Any trailing action should be hidden in an overflow button on the side.

<img 
    src="https://user-images.githubusercontent.com/586552/222218613-1d9826bd-9462-45e7-a4d9-985bcc9e69b9.png"
    role="presentation"
    width="960"
    alt="Title bar action regions displayed in a narrow viewport"
/>
