...
Side sheets are considered as dialogs, which means that interacting with the content in the background is not possible.
This needs to be indicated by an overlay covering the underlying content, including the navigation.
...
<DoDontContainer>
  <Do>
    ...
    <Caption>Side sheets appear on top of all the underlying content.</Caption>
  </Do>
  <Dont>
    <img width="464" alt="" src="https://github.com/primer/design/assets/980622/f05aa559-a866-47cf-84a2-f4897f1da08c" />
    <Caption>Avoid that underlying content (including the navigation) is still interactable.</Caption>
  </Dont>
</DoDontContainer>
