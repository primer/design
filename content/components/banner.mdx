...
A title is required and will be used as the accessibility title. However, you can visually hide the title. It is recommended to hide the title if the body of the banner is short and easily scannable.
...
If a banner informs about something that relates to the current page should be placed above the pages headline. However, if the banner is only relevant to a portion of the page place it above the section it relates to.

In dialogs banners are normally placed above the content jsut below the dialogs header. Since a dialog is normally small it can be compared to a section.
