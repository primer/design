...
-  When a popover is opened, focus should be moved to the popover so that keyboard users can interact with it. When the popover is closed, focus should be returned to the element that triggered it. For more on focus management, see the accessibility guidelines [here](/guides/accessibility/focus-management).
