...
On smaller breakpoints the select panel becomes a full screen dialog or a bottom sheet. Support at 320px is required if the select panel is larger at wider viewports. See [narrow-viewport placement](https://primer.style/design/components/dialog#narrow-viewport-placement) in the Dialog guidelines for more details.
