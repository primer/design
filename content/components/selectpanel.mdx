...
<img
  width="960"
  alt="Multi-select"
  src="https://github.com/primer/design/assets/980622/251ddaa5-28da-41db-84b0-6a4329fe1b11"
/>

If the select panel doesn't have an additional checkbox in the footer, an instant selection can be made, resulting in the panel closing immediately upon selection. This behavior is indicated by a checkmark on the items.

On the other hand, when the footer includes a checkbox it requires the presence of both a cancel and confirmation button. This allows users to utilize the checkbox before they confirm their choices. Visual radio buttons in the items convey this behavior, although they are not semantically radio buttons.
