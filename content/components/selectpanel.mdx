...
The select panel can appear as a anchored dialog or floating dialog.
...
- **Floating dialog**: When triggered by a [button](/components/button), [icon button](/components/icon-button) or [action menu](/components/action-menu).
