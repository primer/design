...
<DoDontContainer>
  <Do>
    ...
    />
    <Caption>
      For multi selection have the user confirm their selection unless it's a{' '}
      <a href="#cancelsubmit">passive selection</a>.
    </Caption>
  </Do>
  <Dont>
    ...
    <Caption>
      ...
      selection unless it's a <a href="#cancelsubmit">passive selection</a>.
    </Caption>
  </Dont>
</DoDontContainer>
