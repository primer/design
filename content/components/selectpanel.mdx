...
We recommend assuming an active selection for less frequently used parts of the platform to avoid accessibility concerns. However, it is important to understand that in areas of the platform that are used frequently, users may want to perform actions as quickly as possible.
