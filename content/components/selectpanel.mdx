...
- **Header:** The header always includes a title and a close button. Additionally, it can have an optional search/filter field to find items quicker. When a selection is made, a "Deselect all" button should also be present.
...
<img width="960" alt="" src="https://github.com/primer/design/assets/980622/5328affe-0c35-4fbf-8f8e-ca3ee95083d4" />

Within the select panel, there are multiple ways to clear data.

- **Search/filter input**: Includes an x-circle-fill icon to clear the input value easily.
- **List (search)**: Provides an Icon button in the header specifically designed to deselect all items in the list with a single click.
- **List (no search)**: Features a list header containing a checkbox to efficiently select/deselect all items in the list at once.
...
<DoDontContainer>
  ...
  <Dont>
    ...
    />
    <Caption>
      Don't forget to display a clear button in the header when one or more items are selected in a multi-select panel.
    </Caption>
  </Dont>
</DoDontContainer>
...
<img width="1338" alt="" src="https://github.com/primer/design/assets/980622/28aeeca1-01d7-444f-964f-6a2744c1ced5" />
