...
<Div display="grid" gridTemplateColumns={['1fr', null, null, null, '1fr 1fr']} gridGap={5}>
  <Box>
...
<Div mb={6} display="grid" gridTemplateColumns={['1fr', null, null, null, '1fr 1fr']} gridGap={5}>
  <Box>
    <Heading as="h4" sx={{fontSize: 5}}>Open source</Heading>
    <Div as="p" sx={{fontSize: 3}}>Primer is open-sourced on GitHub. Contributions and feedback are welcome!</Div>
