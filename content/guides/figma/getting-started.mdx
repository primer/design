...
The Primer Figma libraries contain UI components and design tokens (`variables` and `styles`) that our teams at GitHub use to design GitHub. The components contained within Primer match what is available for developers in Primer React Components, Primer ViewComponents, and Primer CSS.
...
Styles and variables are two very similar ways of bringing `design tokens` like [Primer Primitives](https://github.com/primer/primitives) into Figma.
...
<ImageBox caption="Switching the variable mode changes all nested items">
  <img
    width="800"
    alt="Screen recording of switching variable modes in Figma"
    src="https://github.com/primer/design/assets/813754/0675a32c-3c24-40a7-a030-4c60e1b0409f"
  />
</ImageBox>
