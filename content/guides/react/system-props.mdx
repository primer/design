...
System props are deprecated in all components except [Box](/components/box/react) and [Text](/components/text/react). Please use the [`sx` prop](/guides/react/overriding-styles) instead.
