...
- [ ] **Leverage Primer**: Leverages the foundational building blocks and tools of Primer. Reuses or extends existing patterns and primitives rather than creating overrides 
    ...
    - [ ] Responsive
- [ ] High Design Quality: Visually in harmony with GitHub UI and all visual elements are used are in their correct context
- [ ] Code as a top concern: Designed with code quality and component API top of mind
- [ ] Inclusive: Designs follow Primer accessibility guidelines and consider a global audience 
- [ ] Documentation: Design patterns are [documented](https://primer.style/design/guides/contribute/documentation) for easy adoption
