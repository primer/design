...
- The component can be on any state on the maturity spectum from low to high. Please refer to the `status checklist in the component documentation` for fine-grained information about the component's maturity.
- The component can be ready for preliminary usage depending on its maturity. Please reach out to #primer to discuss further.
